...
class SmshostingVerify: NSObject {
    ...
    static func sendPinWithPhoneNumberAndText(phoneNumber: String, text: String, sandbox:Bool, completion: @escaping (_ result: [String:Any]) -> Void) {
        //Send SMS with PIN
    ...
    static func verifyWithIdAndCode(verifyId: String, verifyCode: String, completion: @escaping (_ result: [String:Any]) -> Void) {
    ...
    static func getCountryCodes( completion: @escaping (_ result: [[String:Any]]) -> Void) {
        //Get Country Codes
    ...
    static func handleRequestErrors(response:URLResponse?, data:Data?, error:Error?) -> [String:Any]{
    ...
    static func handleNoCredentials() -> [String:Any]{
